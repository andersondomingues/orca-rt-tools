...
add wave -noupdate -expand -group tcd_if {/tb/pe_x[0]/pe_y[0]/pe_mod/tcd_if/addr_in}
add wave -noupdate -expand -group tcd_if {/tb/pe_x[0]/pe_y[0]/pe_mod/tcd_if/nbytes_in}
add wave -noupdate -expand -group tcd_if {/tb/pe_x[0]/pe_y[0]/pe_mod/tcd_if/req_in}
add wave -noupdate -expand -group tcd_if {/tb/pe_x[0]/pe_y[0]/pe_mod/tcd_if/ack_in}
add wave -noupdate -expand -group tcd_if {/tb/pe_x[0]/pe_y[0]/pe_mod/tcd_if/irq_out}
...
add wave -noupdate -expand -group mmio_if {/tb/pe_x[0]/pe_y[0]/pe_mod/mmio_if/addr_in}
add wave -noupdate -expand -group mmio_if {/tb/pe_x[0]/pe_y[0]/pe_mod/mmio_if/data_in}
...
add wave -noupdate -expand -group ddma_if {/tb/pe_x[0]/pe_y[0]/pe_mod/ddma_if/addr_in}
add wave -noupdate -expand -group ddma_if {/tb/pe_x[0]/pe_y[0]/pe_mod/ddma_if/nbytes_in}
...
WaveRestoreCursors {{Cursor 1} {3032 ps} 0}
