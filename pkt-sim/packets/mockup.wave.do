...
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/MEMORY_BUS_WIDTH}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/FLIT_WIDTH}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/INTERLEAVING_GRAIN}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/ADDRESS}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/clock}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/reset}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/irq}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/i_token}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/i_flip_counter}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/rstate}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/flits_to_recv}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/RECV_BASE_POINTER}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/RECV_BUFFER_SIZE}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/recv_addr}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/sstate}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/temp_addr_in}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/temp_num_flits_in}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/temp_destination}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/has_data_to_send}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/has_data_to_recv}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/r_data_o}
add wave -noupdate -expand -group 00_ddma_state {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/mem_data_out_dly}
add wave -noupdate -expand -group 00_mem_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/mem_if_dma/MEMORY_BUS_WIDTH}
add wave -noupdate -expand -group 00_mem_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/mem_if_dma/data_in}
add wave -noupdate -expand -group 00_mem_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/mem_if_dma/addr_in}
add wave -noupdate -expand -group 00_mem_ddma -color Orange {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/mem_if_dma/data_out}
add wave -noupdate -expand -group 00_mem_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/mem_if_dma/enable_in}
add wave -noupdate -expand -group 00_mem_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/mem_if_dma/wb_in}
...
add wave -noupdate -group 00_mmio_if {/manycore_top/pe_x[1]/pe_y[1]/pe_mod/mem_if_mmio/enable_in}
...
add wave -noupdate -group 00_Reg_Bank {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/cpu_mod/processor/core/register_bank/clock}
add wave -noupdate -group 00_Reg_Bank {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/cpu_mod/processor/core/register_bank/read_reg1}
add wave -noupdate -group 00_Reg_Bank {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/cpu_mod/processor/core/register_bank/read_reg2}
add wave -noupdate -group 00_Reg_Bank {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/cpu_mod/processor/core/register_bank/write_reg}
add wave -noupdate -group 00_Reg_Bank {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/cpu_mod/processor/core/register_bank/wreg}
add wave -noupdate -group 00_Reg_Bank {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/cpu_mod/processor/core/register_bank/write_data}
add wave -noupdate -group 00_Reg_Bank {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/cpu_mod/processor/core/register_bank/read_data1}
add wave -noupdate -group 00_Reg_Bank {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/cpu_mod/processor/core/register_bank/read_data2}
add wave -noupdate -group 00_Reg_Bank -expand {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/cpu_mod/processor/core/register_bank/registers}
...
WaveRestoreCursors {pkt {77007998 ps} 1}
...
update
WaveRestoreZoom {77004096 ps} {77025336 ps}
