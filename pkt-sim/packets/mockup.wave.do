...
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/MEMORY_BUS_WIDTH}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/FLIT_WIDTH}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/INTERLEAVING_GRAIN}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/ADDRESS}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/clock}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/reset}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/istate}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/i_flip_counter}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/sstate}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/rstate}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/temp_addr_in}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/temp_num_flits_in}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/temp_destination}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/temp_flits_to_recv}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/temp_recv_addr}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/has_data_to_send}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/has_data_to_recv}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/recv_ack_past}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/recv_ack}
add wave -noupdate -group 00_ddma {/manycore_top/pe_x[0]/pe_y[0]/pe_mod/ddma_mod/old_recv_cmd_in}
...
add wave -noupdate -expand -group 01_mem_ddma {/manycore_top/pe_x[0]/pe_y[1]/pe_mod/mem_if_dma/MEMORY_BUS_WIDTH}
add wave -noupdate -expand -group 01_mem_ddma {/manycore_top/pe_x[0]/pe_y[1]/pe_mod/mem_if_dma/data_in}
add wave -noupdate -expand -group 01_mem_ddma {/manycore_top/pe_x[0]/pe_y[1]/pe_mod/mem_if_dma/addr_in}
add wave -noupdate -expand -group 01_mem_ddma {/manycore_top/pe_x[0]/pe_y[1]/pe_mod/mem_if_dma/data_out}
add wave -noupdate -expand -group 01_mem_ddma -expand {/manycore_top/pe_x[0]/pe_y[1]/pe_mod/mem_if_dma/wb_in}
...
WaveRestoreCursors {pkt {77007998 ps} 1} {{Cursor 2} {144215221 ps} 1} {{Cursor 3} {144209248 ps} 0}
...
update
WaveRestoreZoom {144209030 ps} {144231971 ps}
