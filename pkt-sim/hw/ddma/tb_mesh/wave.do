...
add wave -noupdate -expand -group 00_mem_ddma {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/mem_if_dma/MEMORY_BUS_WIDTH}
add wave -noupdate -expand -group 00_mem_ddma {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/mem_if_dma/clock}
add wave -noupdate -expand -group 00_mem_ddma {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/mem_if_dma/reset}
add wave -noupdate -expand -group 00_mem_ddma {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/mem_if_dma/data_in}
add wave -noupdate -expand -group 00_mem_ddma {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/mem_if_dma/addr_in}
add wave -noupdate -expand -group 00_mem_ddma {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/mem_if_dma/data_out}
add wave -noupdate -expand -group 00_mem_ddma {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/mem_if_dma/enable_in}
add wave -noupdate -expand -group 00_mem_ddma {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/mem_if_dma/wb_in}
add wave -noupdate -expand -group router_00 -color Magenta {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/router_mod/router_mod/SwitchControl/ES}
add wave -noupdate -expand -group router_00 -expand {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/router_mod/router_mod/rx}
add wave -noupdate -expand -group router_00 -childformat {{{/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/router_mod/router_mod/data_in(4)} -radix hexadecimal}} -expand -subitemconfig {{/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/router_mod/router_mod/data_in(4)} {-height 17 -radix hexadecimal}} {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/router_mod/router_mod/data_in}
add wave -noupdate -expand -group router_00 {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/router_mod/router_mod/credit_o}
add wave -noupdate -expand -group router_00 {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/router_mod/router_mod/tx}
add wave -noupdate -expand -group router_00 -expand {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/router_mod/router_mod/data_out}
add wave -noupdate -expand -group router_00 {/ddma_noc_top/pe_x[0]/pe_y[0]/pe_mod/router_mod/router_mod/credit_i}
...
add wave -noupdate -group router_01 -expand {/ddma_noc_top/pe_x[0]/pe_y[1]/pe_mod/router_mod/router_mod/credit_o}
...
add wave -noupdate -group router_01 -expand {/ddma_noc_top/pe_x[0]/pe_y[1]/pe_mod/router_mod/router_mod/credit_i}
...
add wave -noupdate -expand -group router_10 {/ddma_noc_top/pe_x[1]/pe_y[0]/pe_mod/router_mod/router_mod/rx}
add wave -noupdate -expand -group router_10 {/ddma_noc_top/pe_x[1]/pe_y[0]/pe_mod/router_mod/router_mod/data_in}
add wave -noupdate -expand -group router_10 {/ddma_noc_top/pe_x[1]/pe_y[0]/pe_mod/router_mod/router_mod/credit_o}
add wave -noupdate -expand -group router_10 {/ddma_noc_top/pe_x[1]/pe_y[0]/pe_mod/router_mod/router_mod/tx}
add wave -noupdate -expand -group router_10 {/ddma_noc_top/pe_x[1]/pe_y[0]/pe_mod/router_mod/router_mod/data_out}
add wave -noupdate -expand -group router_10 {/ddma_noc_top/pe_x[1]/pe_y[0]/pe_mod/router_mod/router_mod/credit_i}
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{End Test 1} {6100960 ps} 0 Cyan Cyan} {Trace {2499967633 ps} 0}
...
update
WaveRestoreZoom {6085094 ps} {6140625 ps}
